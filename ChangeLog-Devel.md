...
- Negotiator version 3.15, which implements the whole access workflow and all datasets are registered in the database.
...
### January Release
These are the features available in the production version
- Dashboard: A mockup of the User's library in the home page once a user is authenticated.
- Catalogue: EMX2 version deployed.
- Explorer (Federated Search). This is not functional in the development platform
- Negotiator: Version 3.15 of backend and UI deployed.
